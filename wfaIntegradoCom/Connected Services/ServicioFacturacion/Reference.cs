...
namespace wfaIntegradoCom.ServicioFacturacion {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://service.sunat.gob.pe", ConfigurationName="ServicioFacturacion.billService")]
    public interface billService {
        ...
        wfaIntegradoCom.ServicioFacturacion.getStatusResponse getStatus(wfaIntegradoCom.ServicioFacturacion.getStatusRequest request);
        ...
        wfaIntegradoCom.ServicioFacturacion.sendBillResponse sendBill(wfaIntegradoCom.ServicioFacturacion.sendBillRequest request);
        ...
        wfaIntegradoCom.ServicioFacturacion.sendPackResponse sendPack(wfaIntegradoCom.ServicioFacturacion.sendPackRequest request);
        
        // CODEGEN: El parámetro 'ticket' requiere información adicional de esquema que no se puede capturar con el modo de parámetros. El atributo específico es 'System.Xml.Serialization.XmlElementAttribute'.
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="ticket")]
        wfaIntegradoCom.ServicioFacturacion.sendSummaryResponse sendSummary(wfaIntegradoCom.ServicioFacturacion.sendSummaryRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public wfaIntegradoCom.ServicioFacturacion.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(wfaIntegradoCom.ServicioFacturacion.statusResponse status) {
            this.status = status;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : wfaIntegradoCom.ServicioFacturacion.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<wfaIntegradoCom.ServicioFacturacion.billService>, wfaIntegradoCom.ServicioFacturacion.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        wfaIntegradoCom.ServicioFacturacion.getStatusResponse wfaIntegradoCom.ServicioFacturacion.billService.getStatus(wfaIntegradoCom.ServicioFacturacion.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public wfaIntegradoCom.ServicioFacturacion.statusResponse getStatus(string ticket) {
            wfaIntegradoCom.ServicioFacturacion.getStatusRequest inValue = new wfaIntegradoCom.ServicioFacturacion.getStatusRequest();
            inValue.ticket = ticket;
            wfaIntegradoCom.ServicioFacturacion.getStatusResponse retVal = ((wfaIntegradoCom.ServicioFacturacion.billService)(this)).getStatus(inValue);
            return retVal.status;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        wfaIntegradoCom.ServicioFacturacion.sendBillResponse wfaIntegradoCom.ServicioFacturacion.billService.sendBill(wfaIntegradoCom.ServicioFacturacion.sendBillRequest request) {
            return base.Channel.sendBill(request);
        }
        
        public byte[] sendBill(string fileName, byte[] contentFile, string partyType) {
            wfaIntegradoCom.ServicioFacturacion.sendBillRequest inValue = new wfaIntegradoCom.ServicioFacturacion.sendBillRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            wfaIntegradoCom.ServicioFacturacion.sendBillResponse retVal = ((wfaIntegradoCom.ServicioFacturacion.billService)(this)).sendBill(inValue);
            return retVal.applicationResponse;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        wfaIntegradoCom.ServicioFacturacion.sendPackResponse wfaIntegradoCom.ServicioFacturacion.billService.sendPack(wfaIntegradoCom.ServicioFacturacion.sendPackRequest request) {
            return base.Channel.sendPack(request);
        }
        
        public string sendPack(string fileName, byte[] contentFile, string partyType) {
            wfaIntegradoCom.ServicioFacturacion.sendPackRequest inValue = new wfaIntegradoCom.ServicioFacturacion.sendPackRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            wfaIntegradoCom.ServicioFacturacion.sendPackResponse retVal = ((wfaIntegradoCom.ServicioFacturacion.billService)(this)).sendPack(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        wfaIntegradoCom.ServicioFacturacion.sendSummaryResponse wfaIntegradoCom.ServicioFacturacion.billService.sendSummary(wfaIntegradoCom.ServicioFacturacion.sendSummaryRequest request) {
            return base.Channel.sendSummary(request);
        }
        
        public string sendSummary(string fileName, byte[] contentFile, string partyType) {
            wfaIntegradoCom.ServicioFacturacion.sendSummaryRequest inValue = new wfaIntegradoCom.ServicioFacturacion.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            wfaIntegradoCom.ServicioFacturacion.sendSummaryResponse retVal = ((wfaIntegradoCom.ServicioFacturacion.billService)(this)).sendSummary(inValue);
            return retVal.ticket;
        }
    }
}
