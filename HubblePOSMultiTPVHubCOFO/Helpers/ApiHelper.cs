...
namespace HubFirebase.Helpers
{
    internal static class ApiHelper
    {
        ...
        /// <param name="tracer"></param>
        /// <returns></returns>
        public static Tuple<HttpStatusCode, string> Put<T>(string url,
            T request,
            string contentType,
            //ILogger logger,
            Dictionary<string, string> queryParams = null,
            ...
            bool tracer = true) where T : class
        {
            ...
            using (HttpClientHandler httpClientHandler = new HttpClientHandler())
            {
                using (HttpClient httpClient = new HttpClient(new LoggingHandler(httpClientHandler, tracer)))
                {
                    ...
                    HttpResponseMessage httpResponse = httpClient.PutAsync(PrepareUrl(url, queryParams), httpContent).Result;
    ...
    internal class LoggingHandler : DelegatingHandler
    {
        ...
        //private readonly clsUtil objUtil= null;
       ...
       : base(innerHandler)
        ...
        {
            //objUtil.gsLogAplicativo("Api Helper Interceptor", "SendToLog", JsonConvert.SerializeObject(logMetadata, Formatting.Indented));
